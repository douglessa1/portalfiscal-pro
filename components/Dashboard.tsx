...
import { Calendar, CheckCircle2, AlertTriangle, Clock, ChevronRight, Server, FileText, ArrowRight, Bell } from 'lucide-react';
                  ...
                  <div className="relative pl-8 group">
                      ...
                      <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all group-hover:border-amber-200 dark:group-hover:border-amber-900">
                          ...
                          <div className="flex gap-3">
                              <button className="text-sm font-bold text-white bg-slate-900 dark:bg-white dark:text-slate-900 px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">Iniciar Envio</button>
                              <button className="text-sm font-bold text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-600 px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">Verificar Erros</button>
                          </div>
                      </div>
                  </div>
