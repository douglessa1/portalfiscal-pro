        ...
        <div className="flex flex-col md:flex-row gap-6 h-[calc(100vh-8rem)] animate-fade-in-up">
            ...
            <div className="w-full md:w-64 flex-shrink-0 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col p-4">
                ...
                <div className="space-y-1 flex-1">
                    ...
                    <NavButton icon={Landmark} label="Banco Inter" sub="Principal" onClick={() => {}} />
                    <NavButton icon={Landmark} label="Nubank" sub="Reserva" onClick={() => {}} />
                </div>

                <button className="w-full mt-4 py-3 bg-emerald-600 text-white rounded-xl font-bold text-sm shadow-lg hover:bg-emerald-500 transition-colors flex items-center justify-center gap-2">
