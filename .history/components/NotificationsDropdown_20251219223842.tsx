...
export const NotificationsDropdown: React.FC<NotificationProps> = ({ onClose }) => {
    ...
    const allNotifications = [
        ...
        // Notificações adicionais para o modal "Ver todas"
        { id: 5, type: 'info', title: 'Novo Decreto', msg: 'Alterações na legislação de ICMS.', time: '2d atrás', icon: Info, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
        { id: 6, type: 'success', title: 'NF Validada', msg: 'Sua nota fiscal 12345 foi validada.', time: '2d atrás', icon: CheckCircle2, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/20' },
    ];
